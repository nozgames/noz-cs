...
public static class AssetManifest
{
    ...
    private static void Publish(string path, byte[] contents)
    {
        // Generate completely before touching the last working manifest. Rename
        // within the same directory so readers see either complete version.
